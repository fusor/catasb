...
ANS_CODE="../ansible"
source ./common_vars
ansible-playbook -u ${EC2_USER} --private-key ${AWS_SSH_PRIV_KEY_PATH} -i ${ANS_CODE}/library/inventory/ec2.py ${ANS_CODE}/setup_environment.yml --extra-vars "${EXTRA_VARS}"
